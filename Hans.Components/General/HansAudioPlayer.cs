...
namespace Hans.Components.General
{
    ...
    {
        private readonly Core.FileSystem.FileSystem _fileSystem;
        ...
        public HansAudioPlayer(HansMusicLibrary library, IAudioPlayer audioPlayer, SongDownloads songDownloads, Core.FileSystem.FileSystem fileSystem)
        {
        ...
        public void Download(IOnlineServiceTrack track)
        {
            ...
            {
                DestinationDirectory = StaticSettings.DownloadTempDirectory,
